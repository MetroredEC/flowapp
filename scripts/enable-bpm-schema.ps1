...
$Root = "C:\Users\dbermeo\Desktop\FlowApp\flowapp"
$Backend = Join-Path $Root "backend"
$Schema = Join-Path $Backend "schema_bpm.sql"
...
"@ | Set-Content $Schema -Encoding UTF8

Set-Location $Backend
npx wrangler d1 execute flowapp-db --file .\schema_bpm.sql
npm run type-check

Write-Host "BPM schema aplicado correctamente." -ForegroundColor Green
