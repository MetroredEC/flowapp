...
”‚   ”””” package.json
”‚
””” scripts/setup.sh               † Setup autom¡tico de recursos CF
...
```
Esto crea autom¡ticamente D1, R2, KV y aplica el schema.
...
Worker †’ valida token †’ consume (invalida) †’ registra decisi³n
    †“
Si aprueba y hay m¡s niveles †’ notifica al siguiente aprobador
